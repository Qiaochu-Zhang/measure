...
def detect_space_candidates(
    ...
    try:
        selected_rows, all_rows, v115_summary = basin_v115.select_basin_first_trenches(
            roi, initial_summary, fixed, v115_block_profile
        )
        locator_exception = ""
...
def measure_image(
    ...
    candidates, candidate_diag = detect_space_candidates(image, params)
