...
def integration_tests(temp, execute, require):
    ...
    def verify(
        ...
        book = load_workbook(
            out / "CD_measurement_200K_V1_18_results.xlsx", read_only=True
        )
        for sheet in [
            "measurement_summary",
            "image_summary",
    ...
    verify("stained_line_pitch", root, "line", 100, 160, 100)
